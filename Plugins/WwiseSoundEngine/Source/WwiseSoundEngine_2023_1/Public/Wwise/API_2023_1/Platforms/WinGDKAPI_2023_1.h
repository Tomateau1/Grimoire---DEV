...
class FWwisePlatformAPI_2023_1_WinGDK : public IWwisePlatformAPI
{
public:
	UE_NONCOPYABLE(FWwisePlatformAPI_2023_1_WinGDK);
	FWwisePlatformAPI_2023_1_WinGDK() = default;
	virtual ~FWwisePlatformAPI_2023_1_WinGDK() override {}
...
using FWwisePlatformAPI = FWwisePlatformAPI_2023_1_WinGDK;
