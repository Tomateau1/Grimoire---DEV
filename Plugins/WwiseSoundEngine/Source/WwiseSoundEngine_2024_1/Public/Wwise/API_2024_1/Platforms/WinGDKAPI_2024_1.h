...
#include "Wwise/API/Platforms/WinGDKAPI.h"

#if defined(PLATFORM_WINGDK) && PLATFORM_WINGDK

class FWwisePlatformAPI_2024_1_WinGDK : public IWwisePlatformAPI
{
public:
	UE_NONCOPYABLE(FWwisePlatformAPI_2024_1_WinGDK);
	FWwisePlatformAPI_2024_1_WinGDK() = default;
	virtual ~FWwisePlatformAPI_2024_1_WinGDK() override {}
...
using FWwisePlatformAPI = FWwisePlatformAPI_2024_1_WinGDK;
